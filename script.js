$(document).ready(function(){
    ...
    var typed = new Typed(".typing", {
        strings: ["Front end developer","UI UX Designer","Project Officer", "Blogger", "Designer", "Freelancer","Manager"],
        typeSpeed: 100,
        backSpeed: 60,
        loop: true
    });
    ...
    function showCertificate(title) {
        ...
        certificateTitle.innerText = title;
        certificateDescription.innerText = `This is the description for ${title}.`;
